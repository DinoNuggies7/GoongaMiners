...
local node_def = {
	...
	_mcl_diggroups = {
		handy = { speed = 0.1, level = 1, uses = 0 },
		axey = { speed = 0.1, level = 0, uses = 0 },
		shovely = { speed = 0.1, level = 0, uses = 0 },
		hoey = { speed = 0.1, level = 0, uses = 0 },
		pickaxey = { speed = 0.1, level = 0, uses = 0 },
		swordy = { speed = 0.1, level = 0, uses = 0 },
		swordy_cobweb = { speed = 0.1, level = 0, uses = 0 },
		shearsy = { speed = 0.1, level = 0, uses = 0 },
		shearsy_wool = { speed = 0.1, level = 0, uses = 0 },
		shearsy_cobweb = { speed = 0.1, level = 0, uses = 0 },
	},
