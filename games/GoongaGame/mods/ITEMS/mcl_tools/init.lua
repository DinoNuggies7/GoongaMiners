...
-- CROWBAR
minetest.register_tool("mcl_tools:crowbar", {
	description = "Crowbar",
	inventory_image = "crowbar.png",
	wield_image = "crowbar.png",
	stack_max = 1,
	groups = { tool=1, dig_speed_class=8, enchantability=1 },
	tool_capabilities = {
	...
	_mcl_diggroups = {
		pickaxey = { speed = 6, level = 4, uses = 1562 },
		axey = { speed = 6, level = 4, uses = 1562 },
		swordy_cobweb = { speed = 4, level = 3, uses = 1562 }
	}
})

-- Flint Knife, used for getting vines and leaves for more crafting
minetest.register_tool("mcl_tools:rock_knife", {
	description = "Flint Knife",
	inventory_image = "flint_knife.png",
	wield_image = "flint_knife.png",
	stack_max = 1,
	groups = { tool=1, dig_speed_class=2, enchantability=1 },
	tool_capabilities = {
...
minetest.register_tool("mcl_tools:rock_axe", {
	...
	stack_max = 1,
	groups = { tool=1, axe=1, dig_speed_class=1, enchantability=1 },
	tool_capabilities = {
...
minetest.register_tool("mcl_tools:rock_shovel", {
	...
	stack_max = 1,
	groups = { tool=1, shovel=1, dig_speed_class=1, enchantability=1 },
	tool_capabilities = {
...
-- 	wield_scale = wield_scale,
-- 	groups = { tool=1, pickaxe=1, dig_speed_class=6, fire_immune=1 },
-- 	tool_capabilities = {
-- 		-- 1/1.2
-- 		full_punch_interval = 0.83333333,
-- 		max_drop_level=5,
...
-- 	wield_scale = wield_scale,
-- 	groups = { tool=1, shovel=1, dig_speed_class=6, fire_immune=1 },
-- 	tool_capabilities = {
-- 		full_punch_interval = 1,
-- 		max_drop_level=5,
-- 		damage_groups = {fleshy=5},
...
-- 	wield_scale = wield_scale,
-- 	groups = { tool=1, axe=1, dig_speed_class=6, fire_immune=1 },
-- 	tool_capabilities = {
-- 		full_punch_interval = 1.0,
-- 		max_drop_level=5,
...
-- 	wield_scale = wield_scale,
-- 	groups = { weapon=1, sword=1, dig_speed_class=5, fire_immune=1 },
-- 	tool_capabilities = {
-- 		full_punch_interval = 0.625,
-- 		max_drop_level=5,
-- 		damage_groups = {fleshy=9},
