...
minetest.register_tool("mcl_tools:crowbar", {
	...
	stack_max = 1,
	groups = { tool=1, sword=1, pickaxe=1, axe=1, dig_speed_class=8, enchantability=22},
	tool_capabilities = {
...
minetest.register_tool("mcl_tools:flint_knife", {
	description = "Flint Knife",
	inventory_image = "flint_knife.png",
	wield_image = "flint_knife.png",
	stack_max = 1,
	groups = { tool=1, shears=1, dig_speed_class=2, enchantability=15 },
	tool_capabilities = {
...
minetest.register_tool("mcl_tools:rock_axe", {
	...
	stack_max = 1,
	groups = { tool=1, axe=1, dig_speed_class=1, enchantability=15 },
	tool_capabilities = {
...
minetest.register_tool("mcl_tools:rock_shovel", {
	...
	stack_max = 1,
	groups = { tool=1, shovel=1, dig_speed_class=1, enchantability=15 },
	tool_capabilities = {
